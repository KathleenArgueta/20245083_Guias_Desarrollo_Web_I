...
function imprimirFilas() {
    let $fila = "";
    // Usamos el index (i) proporcionado por forEach para identificar el elemento
...
const editarPaciente = (index) => {
    //Obtener el paciente del arreglo usando el índice
    let paciente = arrayPaciente[index];

    //Llenar el formulario con los datos de ese paciente
    ...
    //Eliminar el registro de la tabla temporalmente
    eliminarPaciente(index);
    mensaje.innerHTML = "Editando paciente. Modifique y guarde.";
    toast.show();
};
